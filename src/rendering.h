...
//   6. DrawDieEdges()         — wireframe edge highlights
//   7. DrawDieBloom()         — specular glow halos (if enabled)
//   8. DrawDieNumberDecals()  — textured number labels
//   9. ApplyBloomPostProcess()— screen-space bloom + fog (if enabled)
//  10. DrawHotbar()           — 2D dice selection UI
//
// ═══════════════════════════════════════════════════════════════════
